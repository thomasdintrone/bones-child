...
class WP_Widget_Recent_Posts_By_Format extends WP_Widget {
	...
	function widget($args, $instance) {
		$cache = wp_cache_get('widget_recent_posts_by_format', 'widget');
...
<?php
		...
		wp_cache_set('widget_recent_posts_by_format', $cache, 'widget');
	}
	...
	function form( $instance ) {
		...
		foreach ($this->post_formats() as $format) {
			$post_format_options[] = '		<option value="post-format-'.$format.'" '.selected('post-format-'.$format, $instance['format'], false).'>'.ucwords($format).'</option>';
		}
?>
...
add_action( 'widgets_init', create_function( '', "register_widget('WP_Widget_Recent_Posts_By_Format');" ) );
